...
KEYBOARD_ZONES = (
    ...
    KeyboardZone("B+", TOP_OCTAVE_NOTES["B+"], WHITE_KEY_WIDTH * 6, TOP_OCTAVE_Y_START, 1.0, TOP_OCTAVE_WHITE_Y_END),
    # Black Keys
    ...
    KeyboardZone("B-", BOTTOM_OCTAVE_NOTES["B-"], WHITE_KEY_WIDTH * 6, BOTTOM_OCTAVE_Y_START, 1.0, BOTTOM_OCTAVE_WHITE_Y_END),
    # Black Keys
