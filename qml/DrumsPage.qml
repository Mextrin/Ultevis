...
Item {
    ...
    readonly property var drumZones: [
        ...
        { name: "Closed Hi-Hat", note: 42, left: 0.02, top: 0.62, right: 0.28, bottom: 0.77, cymbal: true },
        { name: "Open Hi-Hat", note: 46, left: 0.02, top: 0.42, right: 0.28, bottom: 0.58, cymbal: true },
