...
Item {
    ...
    readonly property var drumZones: [
        ...
        { name: "Closed Hi-Hat", note: 42, left: 0.02, top: 0.60, right: 0.28, bottom: 0.75, cymbal: true },
        { name: "Open Hi-Hat", note: 46, left: 0.02, top: 0.40, right: 0.28, bottom: 0.56, cymbal: true },
